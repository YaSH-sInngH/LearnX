...
export default function LearnerDashboard() {
  ...
  const getRecentBadges = () => {
    ...
    return (profile?.achievements || []).filter(a => a.badgeImage).slice(-6).reverse();
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex items-center space-x-4 mb-4">
              <div className="w-16 h-16 bg-gradient-to-br from-primary-500 to-primary-700 rounded-2xl flex items-center justify-center shadow-large">
                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                </svg>
              </div>
              <div>
                <h1 className="text-4xl font-bold text-secondary-900 dark:text-white font-display">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="card p-6 hover:shadow-medium transition-all duration-300">
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-secondary-600 dark:text-secondary-400">Enrolled Tracks</p>
                  <p className="text-2xl font-bold text-secondary-900 dark:text-white">{enrolledTracks.length}</p>
                </div>
              </div>
            </div>
            ...
            <div className="card p-6 hover:shadow-medium transition-all duration-300">
              <div className="flex items-center">
                <div className="p-3 bg-secondary-100 dark:bg-secondary-800 rounded-xl">
                ...
                <div className="ml-4">
                  <p className="text-sm font-medium text-secondary-600 dark:text-secondary-400">Leaderboard</p>
                  <p className="text-2xl font-bold text-secondary-900 dark:text-white">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              <div className="card p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-bold text-secondary-900 dark:text-white">Progress Overview</h2>
                  <div className="flex items-center space-x-2">
                    <div className="w-3 h-3 bg-primary-500 rounded-full"></div>
                    <span className="text-sm text-secondary-600 dark:text-secondary-400">Your Progress</span>
                  </div>
                </div>
                ...
                {enrolledTracks.length > 0 ? (
                    ...
                    {getProgressChartData().map((track, index) => (
                      <div key={index} className="space-y-2">
                        <div className="flex items-center justify-between">
                          <span className="text-sm font-medium text-secondary-700 dark:text-secondary-200 truncate">
                            {track.name}
                          </span>
                  ...
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-lg font-semibold text-secondary-900 dark:text-white mb-2">No tracks enrolled yet</h3>
                    <p className="text-secondary-600 dark:text-secondary-400 mb-4">Start your learning journey by enrolling in tracks</p>
                    <a 
                      href="/tracks" 
            ...
            {/* Badge Showcase */}
            <div className="card p-6">
              <h2 className="text-xl font-bold text-secondary-900 dark:text-white mb-6">Badge Showcase</h2>
                ...
                <div className="grid grid-cols-3 gap-4">
                  {getRecentBadges().map((badge, index) => (
                    <div
                      ...
                      title={badge.name}
                    >
                      <div className="w-16 h-16 bg-gradient-to-br from-warning-100 to-warning-200 dark:from-warning-900/30 dark:to-warning-800/30 rounded-2xl flex items-center justify-center mx-auto shadow-soft group-hover:shadow-medium transition-all duration-300 group-hover:scale-110">
                        {badge.badgeImage ? (
                          <img src={badge.badgeImage} alt={badge.name} className="w-10 h-10 object-contain" />
                        ) : (
          ...
          <div className="mt-8">
            <div className="card p-6">
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-xl font-bold text-secondary-900 dark:text-white">Recently Enrolled Tracks</h2>
                <a 
                  href="/tracks" 
              ...
              {enrolledTracks.length > 0 ? (
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-semibold text-secondary-900 dark:text-white mb-2">No enrolled tracks yet</h3>
                  <p className="text-secondary-600 dark:text-secondary-400 mb-4">Discover amazing learning tracks and start your journey</p>
                  <a 
                    href="/tracks" 
                    className="btn btn-primary"
                  >
