    ...
    <DashboardLayout>
      <div className="max-w-6xl mx-auto py-8">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">{track.title}</h1>
            <p className="text-gray-600 dark:text-gray-300 mt-2">Manage modules for this track</p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 mb-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                {showNotesPreview && (
                  <div className="mt-4 border border-blue-200 bg-blue-50 dark:bg-gray-900 p-4 rounded relative">
                    <button
                      type="button"
                      className="absolute top-2 right-2 text-gray-500 hover:text-gray-800 dark:hover:text-gray-200 text-lg"
              ...
              {editingModule && editingModule.notes && !showAddForm && (
                <div className="mt-4">
                  ...
                  <div className="prose max-w-none bg-gray-50 dark:bg-gray-900 p-4 rounded">
        ...
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Modules ({track.modules?.length || 0})</h2>
          ...
          {track.modules && track.modules.length > 0 ? (
                ...
                <div className="p-6">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2 p-2">
                      ...
                      {module.quiz ? (
                        <span className="text-green-600 text-sm font-medium">✓ Quiz Available</span>
                      ) : (
                        <button
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-600 dark:text-gray-300">Get started by adding your first module.</p>
            </div>
          )}
        </div>
      </div>
      ...
      {showNotesModal && selectedModule && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-lg max-w-2xl w-full p-6 relative">
            ...
            <h3 className="text-xl font-semibold mb-4 text-gray-900 dark:text-white">Module Notes</h3>
            <div className="prose max-w-none dark:prose-invert overflow-y-auto" style={{ maxHeight: '60vh' }}>
